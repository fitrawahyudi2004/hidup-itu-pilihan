...
document.getElementById('pesanWA-tombolYes').style.display = 'none';
document.getElementById('pesanWA-tombolNo').style.display = 'none';
...
*/
  ID_AnimasiTeks = textsec2.innerHTML;textsec2.innerHTML="";
  ...
  ID_AnimasiTeks2 = textsec3.innerHTML;textsec3.innerHTML="";
  function AnimasiTeks2(){
  	stikersec2.style="margin-top:-50px;margin-bottom:0;transform:scale(.9);transition:all .7s ease";
  	scrollContainer.style="transform: scale(1)";
  	new TypeIt("#textsec3", {
      strings: ["" + ID_AnimasiTeks2], startDelay: 200, speed: 37, /* deff 55 */ cursor: false,
      afterComplete: function(){
      	  textsec3.innerHTML = ID_AnimasiTeks2;
          setInterval(berjatuhan,200);
          ...
          setTimeout(function() {
            textsec3.style = "transform:scale(0);transition:all .7s ease";
            setTimeout(function() {
              textsec3.style = "transform:scale(1);transition:all .7s ease";
              textsec3.innerHTML = "<b class='putih merah'>Bowlehh ga nih? 😝💗</b>";
              setTimeout(muncultombol,500);
            }, 300);
          }, 1800);
      },}).go();
   }
    ...
    fungtom=false;
    function muncultombol(){fungtom=true;Tombol.style="opacity:1;transform:scale(1)";}
    function fungsimau(){
      if(fungtom==true){
        fungtom=false;Tombol.style="opacity:0;transform:scale(0)";
        pesanwhatsapp = document.getElementById('pesanWA-tombolYes').innerText;
        menuju();
      }
    }
    ...
    function fungsigamau(){
      if(fungtom==true){
        fungtom=false;Tombol.style="opacity:0;transform:scale(0)";
        pesanwhatsapp = document.getElementById('pesanWA-tombolNo').innerText;
        menuju();
      }
    }
...
function tes(){
  ...
  setTimeout(function() {
        if(fungsi==0){
           ...
           if(skrg==3){fungsi=0;setTimeout(AnimasiTeks,800);setTimeout(function() {stikersec2.style="transform:scale(1);transition:all .7s ease";}, 500);}
...
function menuju(){window.location = "https://api.whatsapp.com/send?phone=6281262166032&text=" + pesanwhatsapp;}
